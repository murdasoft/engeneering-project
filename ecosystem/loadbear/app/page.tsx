...
const relatedTools = [
  { name: "RebarDesign", desc: { en: "Reinforcement section designer", ru: "Конструктор армирования сечения" }, href: "/dashboard/tools/rebardesign", icon: "🔧" },
          ...
          {result && (
            <div className="space-y-4 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a href="/dashboard/tools/rebardesign" target="_blank" rel="noopener noreferrer" className="btn-primary flex-1 flex items-center justify-center gap-2 text-sm"><Shield className="w-4 h-4" /> {t.strengthen} <ArrowRight className="w-4 h-4" /></a>
              </div>
