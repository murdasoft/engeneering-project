...
export async function POST(req: NextRequest) {
  ...
  ["pixel_scale_mm", "environment", "aggression", "project_name", "inspector", "location", "structure_type", "concrete_grade", "rebar_class", "structure_age", "protective_layer_mm"].forEach((key) => {
